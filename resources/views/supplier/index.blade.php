            ...
            <div class="page-header">
                <div class="row align-items-center">
                    ...
                    <div class="col-auto ms-auto">
                        <a href="" class="btn btn-primary " data-bs-toggle="modal" data-bs-target="#add-update" wire:click.prevent="$emit('AddSupplier')">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td class=" col-1 text-center">
                            @if (!$Trashed)
                            @can('Update Supplier')
                            <a class="btn" href="" data-bs-toggle="modal" data-bs-target="#add-update" wire:click.prevent="$emit('UpdateSupplier','{{$supplier->id}}')">
